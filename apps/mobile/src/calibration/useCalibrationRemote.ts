...
export type CalibrationCommand = 'calibration:neutral:start' | 'calibration:action:start' | 'calibration:action:reset' | 'validation:start' | 'validation:reset' | 'motion:validation:start' | 'motion:validation:reset' | 'kick:test:start' | 'kick:test:reset';
